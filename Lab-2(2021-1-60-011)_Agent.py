...
class PlotHistory:
    ...
    def plot_history(self):
        ...
        # Price and stock levels on primary y-axis
        plt.plot(
            self.environment.price_history, label="Price", color="blue", linewidth=2
        )
        plt.axhline(
        ...
        # Units purchased as larger, bold bars
        plt.bar(
            ...
            color="darkorange",
            alpha=0.9,
            width=0.6,  # Adjusted bar width for better visibility
            edgecolor="black",  # Add border to bars for emphasis
        )

        # Titles and labels
        plt.title("Smartphone Price, Stock Levels, and Purchases Over Time")
        plt.ylabel("Price (BDT) / Stock Level")
